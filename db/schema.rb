...
ActiveRecord::Schema.define(version: 2021_12_29_044846) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_buyers_on_purchase_record_id"
  end
  ...
  add_foreign_key "buyers", "purchase_records"
